...
\begin{enumerate}
    ...
    \item The administrator from the IT department should move the \path{start_pseudoid.exe}, \path{handler.txt}, \path{settings.conf} and \path{opensc-pkcs11.dll} files to a directory, from which the \path{.exe} can be executed. Caution: They have to be in the SAME folder. 
