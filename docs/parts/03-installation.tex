...
Installation is analogous to the Windows installation, except the installer is called (ALIIAS\_macos\_v*.zip) and some file extensions after unzipping will be different (\path{.so} instead of \path{.dll}, no extension instead of \path{.exe}).
